...
struct stats {
    ...
    void printStats() {
        printf("RESULT Algo=RMQ_SDSL_BP_FAST_1024 ConstructTime=%f",construction_time);
...
int main(int argc, char *argv[]) {
    ...
    s = time();
    rmq_succinct_bp_fast<1024> rmq(&A);
    ...
    //write_structure<HTML_FORMAT>(rmq, "rmq_1024.html"); 
